          ...
          <div className="contact--info">
            <div className="contact--card">
              ...
              <span className="contact--card-data">
                tanishqsrivastava217@gmail.com
              </span>

              <a href="mailto:tanishqsrivastava217@gmail.com" className="contact--button">
                Write me
            ...
            <div className="contact--card">
              ...
              <span className="contact--card-data">+91-9161349106</span>
            </div>
